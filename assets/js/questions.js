...
function showQuetions(index) {
  ...
  let option_tag =
    '<div class="option"><span class="option_txt"><img class="option_alph" src="/assets/img/A.png">' +
    quest[index].options[0] +
    '</span></div>' +
    '<div class="option"><span class="option_txt"><img class="option_alph" src="/assets/img/B.png">' +
    quest[index].options[1] +
    '</span></div>' +
    '<div class="option"><span class="option_txt"><img class="option_alph" src="/assets/img/C.png">' +
    quest[index].options[2] +
    '</span></div>' +
    '<div class="option"><span class="option_txt"><img class="option_alph" src="/assets/img/D.png">' +
    quest[index].options[3] +
    '</span></div>'
